...
Public Class NetMessage
    ...
    Sub New(ByVal newDataType As Char, addresses As Adresses, ByVal ParamArray newParts() As String)
        ...
        For i = 0 To partCount - 1
            parts(i) = Encoding.UTF8.GetBytes(newParts(i))
        Next
    End Sub
    ...
    Public Property Part(ByVal index As Integer) As String
        Get
            Return Encoding.UTF8.GetString(PartBytes(index))
        End Get
        Set(ByVal value As String)
            PartBytes(index) = Encoding.UTF8.GetBytes(value)
        End Set
    End Property
    ...
    Public Overrides Function ToString() As String
        ...
        Dim i As Integer
        For i = 0 To partCount - 1
            result += Encoding.UTF8.GetString(parts(i))
