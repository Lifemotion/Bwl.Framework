...
Public Class SettingsClient
    ...
    Private _settingsFormUiHandler As ISettingsFormUiHandler = New SettingsFormUiHandlerWinForms()
    ...
    Public Function CreateSettingsForm(settingsStorage As SettingsStorageBase, invokeForm As Form) As SettingsDialog
        Return ShowSettingsForm(settingsStorage, invokeForm)
    End Function

    Public Function ShowSettingsForm(settingsStorage As SettingsStorageBase, invokeForm As Form) As SettingsDialog
