...
namespace Bwl.Framework.Avalonia
{
    ...
    {
        private AppBaseAvalonia _appBase;
        ...
        private Window _appForm;
        public Window AppForm => _appForm;


        private void Init()
        {
            _appBase = new AppBaseAvalonia();
        ...
        private void Button4_Click(AutoButton source)
        {
            ...
            _listbox1.Info.BackColor = new UIElementInfo.UIElementInfoColor(Colors.Red.R, Colors.Red.G, Colors.Red.B, Colors.Red.A);
