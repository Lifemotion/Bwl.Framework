...
Class TestAutoUI
    Private WithEvents _appBase As New AppBase()
    ...
    Private WithEvents _button6 As New AutoButton(_appBase.AutoUI, "button6")
    Private WithEvents _button7 As New AutoButton(_appBase.AutoUI, "button7")
    ...
    Public ReadOnly Property AppForm As Form
        Get
            Return _form
        End Get
    End Property
    ...
    Public Sub New()
        ...
        _form = AutoUIForm.Create(_appBase)
    End Sub
    ...
    Private Sub Button4_Click(source As AutoButton) Handles _button4.Click
        ...
        _listbox1.Info.BackColor = Color.Red.ToUIElementInfoColor()
    ...
    Shared _isButton6Red As Boolean = False

    Private Sub Button6_Click(source As AutoButton) Handles _button6.Click
        If _isButton6Red Then
            _button6.Info.BackColor = Color.LightGreen.ToUIElementInfoColor()
            _button6.Info.ForeColor = Color.Black.ToUIElementInfoColor()
        Else
            _button6.Info.BackColor = Color.DarkRed.ToUIElementInfoColor()
            _button6.Info.ForeColor = Color.White.ToUIElementInfoColor()
        End If
        _isButton6Red = Not _isButton6Red
        _appBase.RootLogger.AddMessage("Button6_Click")
    End Sub

    Private Sub Button7_Click(source As AutoButton) Handles _button7.Click
        ' Here we're testing if newly created SettingsStorage would open the form without any manipulations
        Dim settings = New SettingsStorageRoot("Storage", "Storage")
        settings.ShowSettingsForm(Me)
    End Sub
