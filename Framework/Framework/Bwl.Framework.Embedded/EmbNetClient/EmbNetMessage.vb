...
Friend Class EmbNetMessage
    ...
    Sub New(ByVal fromRawBytes() As Byte)
        ...
        Next
        ReDim parts(count - 1)
        DataType = Convert.ToChar(fromRawBytes(0)) ' Replaced Chr with Convert.ToChar
    ...
    Public Property PartDouble(ByVal index As Integer) As Double
        Get
            Return Double.Parse(Part(index)) ' Replaced Val with Double.Parse
        End Get
    ...
    Public Function ToBytes(Optional ByVal rightLeftOffset As Integer = 0) As Byte()
        ...
        result(rightLeftOffset) = Convert.ToByte(DataType) ' Replaced Asc with Convert.ToByte
        ...
        Return result
    End Function
    Public Function GetCopy() As EmbNetMessage
        Dim newMessage As New EmbNetMessage(Me.partCount)
