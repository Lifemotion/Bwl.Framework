...
Public MustInherit Class SettingsStorageBase
    Implements ISettingsStorage, ISettingsStorageForm
    ...
    ' Settings form and its factory, to create settings for different kinds of user interfaces
    Protected WithEvents _settingsForm As ISettingsForm
    Protected Shared _settingsFormFactory As ISettingsFormFactory = Nothing
    ...
    Public Event SettingsFormClosed As EventHandler
    ...
    Protected Friend ReadOnly Property SettingsFormFactory As ISettingsFormFactory
        Get
            Return _settingsFormFactory
        End Get
    End Property
    ...
    Public Shared Sub SetSettingsFormFactory(factory As ISettingsFormFactory)
        If _settingsFormFactory IsNot Nothing Then _
            Throw New InvalidOperationException("Settings form factory is already set! Are you sure you're not trying to use multiple UI types at once?")
        _settingsFormFactory = factory
    End Sub
    ...
    Public Function ShowSettingsForm(invokeForm As Object) As ISettingsForm Implements ISettingsStorageForm.ShowSettingsForm
        _settingsForm = _settingsFormFactory.CreateSettingsForm()
        _settingsForm.ShowSettings(Me)
        _settingsForm.Show()
        Return _settingsForm
    End Function

    Public Function CreateSettingsForm(invokeForm As Object) As ISettingsForm Implements ISettingsStorageForm.CreateSettingsForm
        Dim form = _settingsFormFactory.CreateSettingsForm()
    ...
    Private Sub SettingsFormClosedHandler() Handles _settingsForm.FormClosed
