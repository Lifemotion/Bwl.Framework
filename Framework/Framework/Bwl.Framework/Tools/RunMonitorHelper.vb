...
Public Class RunMonitorHelper
	...
	Private ReadOnly _timer As New Timer(AddressOf OnTimerTick)
	...
	Private Sub OnTimerTick()
		Try
			Dim filePath = Path.GetFullPath(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "..", "monitor.txt"))
