...
''' </summary>
''' <remarks></remarks>
Friend Class EmbLogger
    Private ReadOnly _writers As New List(Of ILogWriter)
    Private _parentLogger As EmbLogger
    Private _childLoggers As New List(Of EmbLogger)
    ...
    Friend Sub New(newParentLogger As EmbLogger, categoryName As String)
    ...
    Public Function CreateChildLogger(categoryName As String) As EmbLogger
        Return New EmbLogger(Me, categoryName)
    End Function

    Public Function DeleteChildLogger(categoryName As String) As EmbLogger
        Dim forDelete As EmbLogger = Nothing
    ...
    Public ReadOnly Property ChildLoggers() As List(Of EmbLogger)
        Get
            Dim newChildLoggersList As New List(Of EmbLogger)(_childLoggers)
