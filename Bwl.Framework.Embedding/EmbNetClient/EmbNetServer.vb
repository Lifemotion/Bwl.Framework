...
''' </summary>
''' <remarks></remarks>
Friend NotInheritable Class ConnectedClient
    ...
    Friend parentStruct As EmbClientData
    Friend parentServer As EmbNetServer
    Friend Sub New(ByVal newIpAddress As String, ByVal newId As Integer, ByVal newParentStruct As EmbClientData, ByVal newParent As EmbNetServer)
        ...
        ReDim tag(31)
    End Sub
    Friend Sub RaiseNewMessage(ByVal message As EmbNetMessage)
...
Friend Class EmbClientData
    ...
    Public directClient As EmbNetClient
...
Friend Class EmbNetServer
    ...
    Private ReadOnly connectedClients As New List(Of EmbClientData)
    ...
    Private Sub AcceptSocket(ByVal data As IAsyncResult)
        ...
        If Not newSocket Is Nothing Then
            Dim newClient As New EmbClientData
            Dim endPoint As IPEndPoint = newSocket.RemoteEndPoint
            newClient.userInfo = New ConnectedClient(endPoint.Address.ToString, GetID, newClient, Me)
    ...
    Private Class MessageClientPack
        Public message As EmbNetMessage
    ...
    Private Sub SocketReceived(ByVal data As IAsyncResult)
        ...
        Dim client As EmbClientData = data.AsyncState
    ...
    ''' <remarks></remarks>
    Private Sub ParseBytesInMessage(ByVal client As EmbClientData, ByVal broken As Boolean)
    ...
    Public Event ReceivedMessage(ByVal message As EmbNetMessage, ByVal client As ConnectedClient)
    Public Event SentMessage(ByVal message As EmbNetMessage, ByVal client As ConnectedClient)
    Friend Sub SystemPerformRemove(ByVal client As EmbClientData)
        client.tcpSocket.Close()
    ...
    Private Sub PingClients() Handles pingTimer.Elapsed
        ...
        End Try
    End Sub
    Friend Sub SystemSendMessage(ByVal client As EmbClientData, ByVal message As EmbNetMessage)
    ...
    ''' <remarks></remarks>
    Public Overloads Sub SendMessage(ByVal client As ConnectedClient, ByVal message As EmbNetMessage)
    ...
    ''' <param name="message"></param>
    ''' <remarks></remarks>
    Public Overloads Sub SendMessage(ByVal clientID As Integer, ByVal message As EmbNetMessage)
        For Each connClient In connectedClients.ToArray
