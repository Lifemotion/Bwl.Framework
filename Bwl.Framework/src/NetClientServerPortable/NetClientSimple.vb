...
Public Class NetClientSimple
    ...
    Private waitingResult As NetMessageSimple
    ...
    Private Sub MessageReceived(ByVal message As NetMessageSimple)
    ...
    ''' <remarks></remarks>
    Public Event SentMessage(ByVal message As NetMessageSimple)
    ''' <summary>
    ...
    ''' <remarks></remarks>
    Public Function SendMessageWaitAnswer(ByVal message As NetMessageSimple, ByVal answerFirstPart As String, Optional ByVal timeout As Single = 20.0) As NetMessageSimple
        SyncLock waiterRoot
            Try
                ...
                SendMessage(message)
                Dim time As Double = Microsoft.VisualBasic.Timer
