...
Public Class SettingsStorage
    ...
    Public Function CreateIntegerSetting(name As String, defaultValue As Integer, Optional friendlyName As String = "", Optional description As String = "",
                                            Optional userGroups As String() = Nothing, Optional readOnlyField As Boolean = False) As IntegerSetting
        Return New IntegerSetting(Me, name, defaultValue, friendlyName, description, userGroups, readOnlyField)
    End Function
    Public Function CreateDoubleSetting(name As String, defaultValue As Double, Optional friendlyName As String = "", Optional description As String = "",
                                            Optional userGroups As String() = Nothing, Optional readOnlyField As Boolean = False) As DoubleSetting
        Return New DoubleSetting(Me, name, defaultValue, friendlyName, description, userGroups, readOnlyField)
    End Function
    ...
    Public Function CreateBooleanSetting(name As String, defaultValue As Boolean, Optional friendlyName As String = "", Optional description As String = "",
        ...
        Return New BooleanSetting(Me, name, defaultValue, friendlyName, description, userGroups, readOnlyField)
    End Function
    Public Function CreatePasswordSetting(name As String, Optional friendlyName As String = "", Optional description As String = "",
                                            Optional userGroups As String() = Nothing) As PasswordSetting
        Return New PasswordSetting(Me, name, friendlyName, description, userGroups)
    End Function
    Public Function CreateVariantSetting(name As String, defaultValue As String, variants As String(), Optional friendlyName As String = "", Optional description As String = "",
                                            Optional userGroups As String() = Nothing) As VariantSetting
        Return New VariantSetting(Me, name, defaultValue, variants, friendlyName, description, userGroups)
    End Function
