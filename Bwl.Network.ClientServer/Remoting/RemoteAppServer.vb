...
Public Class RemoteAppServer
    ...
    Public Shared Function IsNumeric(value As String) As Boolean
        ...
        Return If(Double.TryParse(value, number), True, False)
    End Function

    Public Shared Function Val(str As String) As Double
        ...
        If Double.TryParse(str, NumberStyles.Any, CultureInfo.InvariantCulture, result) Then
            Return result
        End If
        Return 0
    End Function
