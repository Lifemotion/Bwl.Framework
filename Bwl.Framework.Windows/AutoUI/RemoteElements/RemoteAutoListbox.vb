...
Public Class RemoteAutoListbox
    ...
    Private Sub BaseInfoChanged(source As UIElementInfo)
        ...
        Else
            ...
            If Info.BackColor.A = 255 Then If ListBox1.BackColor <> GetColor(Info.BackColor) Then ListBox1.BackColor = GetColor(Info.BackColor)
            If Info.ForeColor.A = 255 Then If ListBox1.ForeColor <> GetColor(Info.ForeColor) Then ListBox1.ForeColor = GetColor(Info.ForeColor)
