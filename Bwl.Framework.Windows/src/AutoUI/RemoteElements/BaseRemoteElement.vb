...
Imports System.Text
Imports Bwl.Framework.UIElementInfo
...
Public Class BaseRemoteElement
    ...
    Public Event RequestToSend As EventHandler(Of (source As IUIElement, dataname As String, data As Byte())) Implements IUIElementRemote.RequestToSend
    ...
    Protected Function GetColor(remoteColor As UIElementInfoColor) As Color
